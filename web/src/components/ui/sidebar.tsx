...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      className={cn(
        "absolute inset-y-0 z-20 hidden w-4 transition-all ease-linear group-data-[side=left]:-right-4 group-data-[side=right]:left-0 after:absolute after:top-1/2 after:start-1/2 after:h-12 after:w-[2px] after:-translate-y-1/2 after:rounded-full after:bg-sidebar-border/70 after:opacity-0 after:transition-[height,opacity] after:duration-150 hover:after:h-16 hover:after:opacity-100 sm:flex ltr:-translate-x-1/2 rtl:-translate-x-1/2",
...
function SidebarMenuButton({
  ...
  const comp = useRender({
    ...
    render: !tooltip ? render : <TooltipTrigger delay={350} render={render} />,
    state: {
