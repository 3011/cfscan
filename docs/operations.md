...
| `CFSCAN_AGENT_IMAGE` | `ghcr.io/3011/cfscan-agent:v2.0.0` | Web 展示的 Agent 容器镜像 |
| `CFSCAN_AGENT_VERSION` | `v2.0.0` | Web 展示的 Agent 推荐版本 |
...
公开版本由 Git Tag 与 GitHub Release 共同定义。共享 Token和双公开地址已在以下破坏性版本中删除：
